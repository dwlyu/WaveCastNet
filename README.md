...
python WaveCastNet/earthquake_train.py --model Swin --num_kernels 144 --patch_size 3 4 4
python WaveCastNet/earthquake_train.py --model Time-s-pyramid --num_kernels 192 --patch_size 1 8 8
python WaveCastNet/earthquake_train.py --model Time-s-plain --num_kernels 192 --patch_size 1 8 8
